...
while True:
    user = api.get_user('CodersOvernight')
    api.update_profile(name=f'codersOvernight|{follower_count(user)} Followers')
    print(f'Updating Twitter Name : codersOvernight|{follower_count(user)} Followers')
